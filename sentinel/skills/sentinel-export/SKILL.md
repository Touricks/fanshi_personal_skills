...
description: Produce submission-ready documents with compliance lint and format rendering. Use when "export", "sentinel-export", "compliance check", "clean for submission", or when the user wants to render project docs to md/pdf/pptx/docx with AI writing pattern detection.
---

# Sentinel Export — Compliance Lint + Format Rendering
